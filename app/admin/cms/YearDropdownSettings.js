...
export default function YearDropdownSettings() {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      <Title level={3}>Year & Dropdown Settings</Title>
      <Row gutter={32}>
        <Col span={12}>
        ...
        <Col span={12}>
          ...
          <Button type="dashed" onClick={addLabel} style={{ marginTop: '10px' }}>
            + Add Label
          </Button>
        </Col>
      </Row>
      <Button type="primary" onClick={saveSettings} style={{ marginTop: '20px' }}>
        Save Settings
      </Button>
    </div>
  );
